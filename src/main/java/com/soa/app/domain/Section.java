...
public class Section implements Serializable {
    ...
    @Column(name = "coef_total")
    private Integer coefTotal;
    ...
    public Integer getCoefTotal() {
        return coefTotal;
    }

    public Section coefTotal(Integer coefTotal) {
        this.coefTotal = coefTotal;
        return this;
    }

    public void setCoefTotal(Integer coefTotal) {
        this.coefTotal = coefTotal;
    }
