...
public class SectionResourceIntTest {
    ...
    private static final Integer DEFAULT_COEF_TOTAL = 1;
    private static final Integer UPDATED_COEF_TOTAL = 2;
    ...
    public void createSection() throws Exception {
        ...
        assertThat(testSection.getCoefTotal()).isEqualTo(DEFAULT_COEF_TOTAL);
    }
    ...
    public void getAllSections() throws Exception {
        ...
        restSectionMockMvc.perform(get("/api/sections?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].coefTotal").value(hasItem(DEFAULT_COEF_TOTAL)));
    }
    ...
    public void getSection() throws Exception {
        ...
        restSectionMockMvc.perform(get("/api/sections/{id}", section.getId()))
            ...
            .andExpect(jsonPath("$.coefTotal").value(DEFAULT_COEF_TOTAL));
    }
    ...
    public void updateSection() throws Exception {
        ...
        assertThat(testSection.getCoefTotal()).isEqualTo(UPDATED_COEF_TOTAL);
    }
