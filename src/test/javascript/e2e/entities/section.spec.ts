...
describe('Section e2e test', () => {
    ...
    it('should create and save Sections', () => {
        ...
        sectionDialogPage.setCoefTotalInput('5');
        expect(sectionDialogPage.getCoefTotalInput()).toMatch('5');
...
export class SectionDialogPage {
    ...
    coefTotalInput = element(by.css('input#field_coefTotal'));
    ...
    setCoefTotalInput = function(coefTotal) {
        this.coefTotalInput.sendKeys(coefTotal);
    }

    getCoefTotalInput = function() {
        return this.coefTotalInput.getAttribute('value');
    }
