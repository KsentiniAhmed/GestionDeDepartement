...
describe('Matiere e2e test', () => {
    ...
    it('should create and save Matieres', () => {
        ...
        matiereDialogPage.setNbrSCInput('5');
        expect(matiereDialogPage.getNbrSCInput()).toMatch('5');
...
export class MatiereDialogPage {
    ...
    nbrSCInput = element(by.css('input#field_nbrSC'));
    ...
    setNbrSCInput = function(nbrSC) {
        this.nbrSCInput.sendKeys(nbrSC);
    }

    getNbrSCInput = function() {
        return this.nbrSCInput.getAttribute('value');
    }
